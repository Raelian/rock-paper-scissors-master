...
const BasicLogo = () => {
    return (
        <img src="src/images/logo.svg" alt="Rock-Paper-Scissors logo" className="basic-logo"/>
    )
}

const MasterLogo = () => {
    return (
        <img src="src/images/logo-bonus.svg" alt="Rock-Paper-Scissors-Lizard-Spock logo" className="master-logo"/>
    )
}
